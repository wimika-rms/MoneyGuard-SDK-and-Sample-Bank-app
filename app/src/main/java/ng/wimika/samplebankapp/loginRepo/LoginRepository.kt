...
interface LoginRepository {
    suspend fun login(email: String, password: String): Flow<ClientSessionResponse>
}
...
class LoginRepositoryImpl: LoginRepository {
    ...
    override suspend fun login(email: String, password: String): Flow<ClientSessionResponse> = flow {
